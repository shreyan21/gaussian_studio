...
MAX_VIDEO_UPLOAD = max(1, int(os.environ.get("GSS_MAX_VIDEO_MB", "750"))) * 1024 * 1024
MAX_TOTAL_UPLOAD = max(1, int(os.environ.get("GSS_MAX_TOTAL_UPLOAD_MB", "1024"))) * 1024 * 1024
